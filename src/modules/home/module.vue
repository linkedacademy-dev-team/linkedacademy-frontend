...
const navigation = [
  ...
  { name: "Colegios", href: "#", icon: HomeModernIcon, current: false },
  { name: "Especialidad", href: "#", icon: LightBulbIcon, current: false },
  { name: "Jornadas", href: "#", icon: CalendarIcon, current: false },
  { name: "Grados", href: "#", icon: DocumentDuplicateIcon, current: false },
  { name: "Modelos educativos", href: "#", icon: ChartPieIcon, current: false },
  {
