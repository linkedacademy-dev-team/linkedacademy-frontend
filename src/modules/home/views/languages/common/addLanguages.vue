              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Crear lenguaje</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
                      <span class="text-sm font-semibold text-gray-700"
                        >Nombre del lenguaje</span
                      >
                      <input
...
const createEthnicGroup = async () => {
  try {
    if (ethnicGroupName.value.length === 0)
      return toast.error("El nombre del lenguaje no puede estar vacío.");
    await store.dispatch("CREATE_LANGUAGE", ethnicGroupName.value);
