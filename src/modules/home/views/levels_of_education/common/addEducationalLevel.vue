              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Crear nivel de educacion</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
                      <span class="text-sm font-semibold text-gray-700"
                        >Nombre del nivel de educacion</span
                      >
                      <input
                        v-model="educationalLevelName"
                        type="text"
...
const educationalLevelName = ref("");

const createEducationalLevel = async () => {
  try {
    if (educationalLevelName.value.length === 0)
      return toast.error(
        "El nombre del nivel de educacion no puede estar vacio"
      );
    await store.dispatch(
      "CREATE_EDUCATION_LEVEL",
      educationalLevelName.value
    );
    educationalLevelName.value = "";
