              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Crear grupo etnico</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
...
const ethnicGroupName = ref("");

const createEthnicGroup = async () => {
  try {
    if (ethnicGroupName.value.length === 0)
      return toast.error("El nombre del grupo etnico no puede estar vacio");
    await store.dispatch("CREATE_ETHNIC_GROUP", ethnicGroupName.value);
    ethnicGroupName.value = "";
