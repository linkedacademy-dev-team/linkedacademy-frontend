            ...
            >
              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Crear modelo de educacion</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
                      <span class="text-sm font-semibold text-gray-700"
                        >Nombre del modelo de educacion</span
                      >
                      <input
                        v-model="educationalModelName"
                        type="text"
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <button
                  ...
                  @click="createEducationalModel"
                >
                  Crear modelo de educacion
                </button>
                <button
                  type="button"
...
const createEducationalModel = async () => {
  ...
  try {
    ...
    await store.dispatch("CREATE_EDUCATIONAL_MODEL", educationalModelName.value);
    educationalModelName.value = "";
