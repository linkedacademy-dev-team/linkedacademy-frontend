<template>
                ...
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <DialogTitle
                      ...
                      >Crear jornada</DialogTitle
                    >
                    <div class="mt-4">
                      <label>
                        <span class="text-sm font-semibold text-gray-700"
                          >Nombre de la jornada</span
                        >
                        <input
  ...
  const schedulesName = ref("");
  
  const createSpecialitie = async () => {
    try {
      if (schedulesName.value.length === 0)
        return toast.error("El nombre de la jornada no puede estar vacío");
      await store.dispatch("CREATE_SESSION", schedulesName.value);
      schedulesName.value = "";
