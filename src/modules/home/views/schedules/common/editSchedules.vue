              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Editar jornada</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
                      <span class="text-sm font-semibold text-gray-700"
                        >Nombre de jornada</span
                      >
                      <input
                        v-model="schedulesData.name"
                        type="text"
...
const editSchedules = async () => {
  try {
    await store.dispatch("UPDATE_SESSION", {
      id: schedulesData.value.id,
      name: schedulesData.value.name,
    });
    close();
    toast.success("Jornada editada correctamente");
  } catch (error) {
    toast.error("Error al jornada la especialidad");
  }
};
