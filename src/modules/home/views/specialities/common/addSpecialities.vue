              ...
              <div class="sm:flex sm:items-start">
                ...
                <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle
                    ...
                    >Crear especialidad</DialogTitle
                  >
                  <div class="mt-4">
                    <label>
...
const createSpecialitie = async () => {
  try {
    if (specialitieName.value.length === 0)
      return toast.error("El nombre de la especialidad no puede estar vacío");
    await store.dispatch("CREATE_SPECIALITY", specialitieName.value);
    specialitieName.value = "";
